...
export const RULES = { style: 'title', after: { 'kings hwy/e 35 st': 'Kings Hwy/E 35 St', 'KINGS HWY/E 35 St': 'Kings Hwy/E 35 St' },
  stops: {
    'Green Acres Rd@ Sunrise Hwy(BestBuy': 'Green Acres Rd @ Sunrise Hwy (Best Buy)',
    'Marcus Ave @ #1111(MarcusBldg East': 'Marcus Ave @ #1111 (Marcus Bldg East)',
    'Bayview Ave Opp Grist Mill La (Libr': 'Bayview Ave Opp Grist Mill La (Library)',
    "Trinity Pl 204'S of Rector & Thames Sts.(Ped Bridg": "Trinity Pl 204' S of Rector & Thames Sts (Ped Bridge)",
  },
};
