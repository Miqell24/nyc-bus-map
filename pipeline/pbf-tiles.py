...
build.mjs cannot tell the difference. New York: the ROAD grid covers the
five boroughs, Nassau County and the Hudson–Essex core of New Jersey
(52 × 85 km), while the RAIL file reaches as far as the Long Island Rail Road
and Metro-North do — Montauk, Greenport, Poughkeepsie, Wassaic, New Haven and
Waterbury (150 × 210 km). Three Geofabrik extracts are read in one pass (New
York, New Jersey, Connecticut; pyosmium with an in-memory node index).
...
PBFS = [os.path.join(ROOT, 'data', f'{st}-latest.osm.pbf') for st in ('new-york', 'new-jersey', 'connecticut')]
...
GEN = 'pbf-tiles.py (Geofabrik new-york + new-jersey + connecticut)'
